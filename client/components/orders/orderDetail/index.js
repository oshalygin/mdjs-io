...
class OrderDetail extends React.Component {
  ...
  render() {
    ...
    const datePlaced = `${dateFns.format(
    ...
    const statusColor = orderDetail.orderStatusID < 100 ? '#5CB85C' : '#F44336';
    ...
    const component = loading
      ...
      : <div styleName="order-detail-container">
          <div
            styleName="order-detail-background-container"
            style={{
              height: `${orderDetail.items.length * 8 + 55}rem`,
            }}
          >
            <div styleName="order-detail-inner-container">
              <div styleName="order-number-label">Order number:</div>
              <div styleName="order-date-label">Date placed:</div>
              ...
              <div styleName="customer-label">Customer:</div>
              <div styleName="status-label">Status:</div>
