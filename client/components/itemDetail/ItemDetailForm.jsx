...
const ItemDetailForm = ({
  ...
  const itemPriceType = itemPriceTypes.find(
    //eslint-disable-next-line eqeqeq
    priceType => priceType.value == item.priceTypeID,
  );
  ...
  const selectedCategory = itemCategories.find(
    category => category.value === item.itemCategoryID,
  );
  ...
  return (
    <div className="ibox-content">
      <div className="row">
        <div className="col-sm-offset-1 col-sm-6">
          <div styleName="control-group">
            <div styleName="extended-control-label">Name</div>
          ...
          <div styleName="control-group">
            <div styleName="extended-control-label">Label</div>
            <div styleName="extended-control-input">
              <TextField
                fullWidth
                name="label"
          ...
          <div styleName="control-group">
            <div styleName="extended-control-label">Price ($)</div>
            <div styleName="extended-control-input">
              <TextField
                fullWidth
                name="price"
        ...
        <div className="col-md-offset-2 col-md-3">
          <ItemImage onDrop={onDrop} itemPreview={item.photoURL} />
        </div>
      </div>
      <div className="row">
        <Divider />
      ...
      <div className="row">
        <div styleName="additional-items-heading">Additional Configuration</div>
      </div>
      <div className="row">
        <Divider />
      </div>
