...
describe('V0 - Discount Controller', () => {
  const discountPostBody = {
    discountID: 0,
    discountName: 'fooDiscount',
    value: 30.33,
    applyTypeID: 0,
    items: [],
  };
  ...
  it('should make a post to the discount create endpoint', async () => {
    const expected = true;
